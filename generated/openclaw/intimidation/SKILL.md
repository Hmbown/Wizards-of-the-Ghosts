...
Intimidation is interpreted here as a metaphorical skill with a shipping-now execution model.

Canonical source: Intimidation (skill)
...
1. Identify the authority chain, required action, deadline, and real consequence of inaction.
2. Draft direct language that matches the severity level and makes the next step unmistakable.
3. Return the escalation message with a note on why the severity is justified and when to soften it.
...
Use $intimidation to draft a serious, authoritative message that matches the actual risk and required action.
