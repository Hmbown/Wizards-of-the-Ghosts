...
1. Inspect the roots and branches: directory layout, dependencies, schema evolution, ownership clues, and naming patterns.
2. Interpret what those structures reveal about coupling, neglected areas, and natural extension points.
3. Return a reading of the system's slow logic, plus where pruning, grafting, or restraint is warranted.
