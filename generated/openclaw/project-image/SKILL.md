...
Project Image is interpreted here as a hybrid spell with a shipping-now execution model.

Canonical source: Project Image (spell)
...
1. Determine what kind of presence is needed: live avatar, recorded message, or automated representative.
2. Define the scope of authority: what can the projection say or do on your behalf?
3. Create and deploy the projection: join the meeting, post the recording, or activate the bot.
4. Monitor for situations that exceed the projection's authority and require your real presence.
5. Debrief on what the projection handled and what required escalation.
...
Use $project-image to set up remote presence — an avatar, recorded stand-in, or automated representative — that projects you into a space you cannot physically attend.
