...
Legend Lore is interpreted here as a metaphorical spell with a shipping-now execution model.

Canonical source: Legend Lore (spell)
...
1. Accept the named subject and any known context or constraints on scope.
2. Search exhaustively across documentation, source code, academic papers, web, and community knowledge.
3. Cross-reference findings and resolve contradictions between sources.
4. Return a structured dossier with sourced claims, confidence levels, and identified gaps.
...
Use $legend-lore to build a comprehensive research dossier on this subject, with sourced claims and confidence levels.
