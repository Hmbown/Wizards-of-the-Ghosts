...
1. Inventory the resources still available and the non-negotiable outcomes that must survive.
2. Choose the leanest route that preserves essentials and stretches the remaining runway.
3. Return a contingency plan with rationing rules, hidden dependencies, and fallback triggers.
