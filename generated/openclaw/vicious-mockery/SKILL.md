...
Vicious Mockery is interpreted here as a metaphorical spell with a shipping-now execution model.

Canonical source: Vicious Mockery (spell)
...
1. Identify the target: the plan, argument, design, code, or proposal to critique.
2. Find the real weaknesses — not cosmetic issues but structural flaws, bad assumptions, or hidden risks.
3. Articulate each weakness in the most vivid, memorable, undeniable way possible.
4. Rank by severity. Lead with the kill shot.
5. Close with one constructive line — the mockery should wound, not kill. The goal is improvement.
...
Use $vicious-mockery to tear apart this [plan/proposal/design/argument]. Find the real weaknesses and state them so sharply they cannot be ignored.
