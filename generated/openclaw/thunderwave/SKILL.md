...
Thunderwave is interpreted here as a literal spell with a prototype execution model.

Canonical source: Thunderwave (spell)
...
1. Identify the target device, webhook, or effect surface.
2. Require explicit confirmation of the payload, boundary, and rollback plan.
3. Trigger the effect through the narrowest possible integration.
4. Report exactly what fired and whether rollback is available.
...
Use $thunderwave to design or trigger a tightly scoped dramatic effect, but stop for confirmation before any irreversible action.
