...
1. Observe the failure patterns, triggers, and safe handling rules the system seems to respond to.
2. Choose gentle interventions, sequencing, and retries that reduce instability instead of amplifying it.
3. Return a stability playbook plus the signs that the system is calming down or getting worse.
