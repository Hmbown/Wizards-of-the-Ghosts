...
Nature is interpreted here as a metaphorical skill with a shipping-now execution model.

Canonical source: Nature (skill)
...
1. Identify the system and its key agents, resources, and feedback loops.
2. Map the ecosystem: who/what interacts with whom/what, and what are the incentive structures?
3. Identify emergent properties: behaviors that arise from interactions rather than from any single agent.
4. Deliver the ecosystem analysis with a note on what is predictable and what is inherently chaotic.
...
Use $nature to analyze this [market/community/ecosystem/pattern] as an emergent system. Map the agents, feedback loops, and what can be influenced vs. what must be adapted to.
