...
1. Identify the experience and its attention drop-off points.
2. Design engagement patterns: progress indicators, micro-rewards, curiosity gaps, or visual anchors.
3. Map the boundary: when should the pattern release attention? Hypnotic Pattern has a duration, not an infinity.
4. Deliver the attention design with an explicit note on where engagement becomes compulsion.
