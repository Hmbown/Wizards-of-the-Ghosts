...
1. Clarify the visual question: layout, styling, content hierarchy, or aesthetic direction.
2. Create a static visual artifact: design comp, rendered mockup, annotated screenshot, or diagram.
3. Present it as a visual reference, not a functional prototype.
4. Gather visual feedback and iterate on the design before investing in interactivity.
